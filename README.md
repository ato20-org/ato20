...
```bash
curl -fL -o ato20.AppImage https://github.com/ato20-org/ato20/releases/download/v0.1.3/ato20_0.1.3_amd64.AppImage && chmod +x ato20.AppImage
./ato20.AppImage
```
...
```powershell
wget https://github.com/ato20-org/ato20/releases/download/v0.1.3/ato20_0.1.3_x64-setup.exe -OutFile ato20-setup.exe
.\ato20-setup.exe
```
...
```powershell
curl.exe -fL -o ato20-setup.exe https://github.com/ato20-org/ato20/releases/download/v0.1.3/ato20_0.1.3_x64-setup.exe
```
...
o nome do pacote: `ato20_0.1.3_amd64.AppImage` deixa de existir na versão seguinte. Para um
