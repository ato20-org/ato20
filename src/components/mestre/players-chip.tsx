 ...
 * personagens e é desenhada por `MestreShell`; daqui sai só o botão.
 *
...
export function PlayersChip() {
  ...
  const { players, loaded, agora, recarregar } = usePlayers(
    aberto ? ABERTO_MS : FECHADO_MS,
  );
  ...
  const presentes = players.filter((player) =>
