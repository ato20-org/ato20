...
export function PlayerMenu({ codigo }: { codigo: string }) {
  ...
  return (
    <>
      ...
      <RenomearDialog codigo={codigo} aberto={renomeando} onFechar={() => setRenomeando(false)} />
    </>
  );
}
      ...
      <AlertDialog open={aberto} onOpenChange={setAberto}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Este aparelho esquece a credencial e volta a pedir um nome. O que você já mandou para
              a mesa fica lá, mas entrar de novo cria um jogador novo — o mestre precisa te ligar de
              volta ao teu personagem.
            </AlertDialogDescription>
          </AlertDialogHeader>
