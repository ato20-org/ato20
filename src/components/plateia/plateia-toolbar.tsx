...
import { SaquinhoPlateia } from "@/components/plateia/saquinho-plateia";
import { cn } from "@/lib/utils";

/**
 * A barra de baixo da Plateia.
 *
 ...
 */
export function PlateiaToolbar({ esquerda, direita }: { esquerda: ReactNode; direita: ReactNode }) {
  return (
