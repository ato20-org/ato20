...
/**
 * A primeira tela de quem abre a Plateia sem ficha neste aparelho.
 *
 ...
 * sem virar jogador tem a porta do lado — `/assistir`, a TV, que nunca cria
    ...
    <div className="flex min-h-0 flex-1 flex-col justify-center overflow-y-auto p-6">
      <div className="mx-auto w-full max-w-sm space-y-6">
        <div className="space-y-2 text-center">
          <UserRound className="text-muted-foreground mx-auto size-8" aria-hidden />
        ...
        >
          ...
          {erro ? <p className="text-destructive text-center text-sm">{erro}</p> : null}
