...
import { useSecoesStore, type SecaoFicha as Secao } from "@/lib/store/use-secoes-store";
    ...
    <section className="space-y-2">
      <div className="flex items-center gap-1">
        ...
        >
          ...
          {contagem ? (
            <span className="text-muted-foreground font-normal">({contagem})</span>
          ) : null}
        </button>
      ...
      {aberta ? (
        <div id={id} className="animate-in fade-in-0 duration-100 motion-reduce:animate-none">
          {children}
        </div>
      ) : null}
    </section>
