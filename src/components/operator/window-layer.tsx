...
import { DockGhost } from "@/components/operator/dock/dock-ghost";
import { DockOverlay } from "@/components/operator/dock/dock-overlay";
import {
  JanelaCorpo,
  larguraPadrao,
  useRotuloJanela,
} from "@/components/operator/dock/window-content";
import { InnerWindow } from "@/components/operator/inner-window";
