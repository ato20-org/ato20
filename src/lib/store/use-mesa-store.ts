 ...
 *
 * Espelha o `use-campaign-store` do Mestre, e por isso existe: "qual mesa
 * está aberta aqui" é estado de aplicação, não estado de um formulário. Quem
 * precisa dele são a porta, o cabeçalho do Jogador e a inscrição no SSE — três
...
type MesaStore = {
   ...
   *
   * Chamado na montagem. O QR do Mestre já traz o código: a TV não tem quem
