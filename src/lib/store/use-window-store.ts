...
export type ConteudoJanela =
  ...
  // isso que o torna prova e não estimativa: o que aparece aqui é o que saiu
  // do daemon, já sem os pontos do mestre e já com a câmera da cena. Sem
  // campo: só há uma mesa.
  | { tipo: "miniplayer" }
